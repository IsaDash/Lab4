...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while(tempPokemon.hitPoints < 1 || tempPokemon.hitPoints > 50) {
        ...
        int maxDefenseLevel = 50 - tempPokemon.attackLevel;

        System.out.println("Enter your defense level (1-" + maxDefenseLevel + "):");
        myScan = new Scanner(System.in);
        tempPokemon.defenseLevel = myScan.nextInt();

        while(tempPokemon.defenseLevel < 1 || tempPokemon.defenseLevel > maxDefenseLevel) {
            System.out.println("Sorry. The defense level must be between 1 and " + maxDefenseLevel + ":");
            myScan = new Scanner(System.in);
            tempPokemon.defenseLevel = myScan.nextInt();
        }
